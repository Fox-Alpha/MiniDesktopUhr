...
namespace MiniDesktopUhrWPF.Helper
{
    ...
    public class Screen
    {
        ...
        static Screen() => multiMonitorSupport = NativeMethods.GetSystemMetrics(NativeMethods.SM_CMONITORS) != 0;
        ...
        private Screen(IntPtr monitor, IntPtr hdc)
        {
            if (!multiMonitorSupport || monitor == (IntPtr)PRIMARY_MONITOR)
            {
                ...
                //this.Bounds = SystemParameters.VirtualScreen;
                this.Primary = true;
